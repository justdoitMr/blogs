...
- [2、策略设计模式](#2策略设计模式)
  - [1、策略模式介绍](#1策略模式介绍)
  - [2、策略模式类图](#2策略模式类图)
  - [3、策略模式使用场景](#3策略模式使用场景)
  - [4、策略模式使用案例](#4策略模式使用案例)
    - [4.1、消除if-else案例](#41消除if-else案例)
    - [4.2、改写if-else](#42改写if-else)
    - [4.3、策略模式骨架](#43策略模式骨架)
  - [5、策略模式优点](#5策略模式优点)
...
![image-20240713152131624](https://vscodepic.oss-cn-beijing.aliyuncs.com/blog/202407131521717.png)
