...
- [1、模板设计模式介绍](#1模板设计模式介绍)
  - [1.1、什么是模板模式](#11什么是模板模式)
  - [1.2、主要解决问题](#12主要解决问题)
  - [1.4、实现方式](#14实现方式)
  - [1.5、关键代码](#15关键代码)
  - [1.6、使用建议](#16使用建议)
...
- [4、应用场景](#4应用场景)
  - [4.1、生活场景](#41生活场景)
  - [4.2 、java场景](#42-java场景)
- [5、代码实现](#5代码实现)
  - [5.1、UML类图](#51uml类图)
  - [5.2、OrderFood——抽象类（Abstract）](#52orderfood抽象类abstract)
  - [5.3、具体类（Concrete Class）](#53具体类concrete-class)
  - [5.4、testTemplate](#54testtemplate)
- [6、总结](#6总结)
...
![img](https://vscodepic.oss-cn-beijing.aliyuncs.com/blog/202407131451445.png)
